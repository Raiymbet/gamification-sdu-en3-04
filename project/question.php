...
<div class="col-7" id="type_2">
    ...
    <div class="col-7" id="type_3" style="display: none">
        <div class="panel panel-default">
            <div class="question" id="p_for_question_type_3" style="margin-bottom: 50px">
                Заполните, пустые строки и слова.
            </div>
            <div class="col-11 col-offset-1">
                <ul id="p_for_question_type_3"></ul>
            </div>
            <button onclick="type_3_method_check_answer()" class="btn btn-danger" style="margin-left: 70%">Check and Next</button>
            <div style="margin-top:50px"></div>
        </div>
    </div>
