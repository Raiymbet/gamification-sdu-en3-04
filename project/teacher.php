                ...
                <div class="panel-body" style="min-height:560px">
                        ...
                        <div class="modal-dialog modal-sm" style="width:400px">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="new_group_name" class="col-sm-2 control-label">Имя
                                                        группы</label>
                                            ...
                                            <div class="row" style="margin-top:8px">
                                                <div class="col-12">
                                                    <div class="btn-group" role="group" aria-label="...">
                                                        <button type="button" onclick='selCategory("eng")'
                                                                class="btn btn-default">English
                                                        </button>
                                                        <button type="button" onclick='selCategory("math")'
                                                                class="btn btn-default">Mathematics
                                                        </button>
                                                        <button type="button" onclick='selCategory("IT")'
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-primary" id='groud_add_btn'>Создать группу
                                    </button>
                                </div>
                            </div>
                            <!-- /.modal-content -->
                    ...
                    <span class='glyphicon glyphicon-remove pull-right' onclick='removeGroups(\"%s\")' style='margin-right:8px'>
                                ...
                                <li role="presentation" name='addGroups' data-toggle="modal" data-target="#myModal"><a
                                        href="#"><span class="glyphicon glyphicon-plus-sign"></span>Создать группу</a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-8">
