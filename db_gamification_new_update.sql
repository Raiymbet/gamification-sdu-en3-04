...
--
-- Хост: 127.0.0.1
-- Время создания: Май 15 2015 г., 06:29
...
(1, 1, 1, 1, '2015-03-05 00:00:00', '2015-03-07 00:00:00'),
(2, 1, 3, 1, '2015-03-05 00:00:00', '2015-03-07 00:00:00'),
(3, 1, 10, 1, '2015-04-16 00:00:00', '2015-04-17 00:00:00'),
(4, 1, 16, 1, '2015-04-17 00:00:00', '2015-04-17 00:00:00'),
(5, 1, 17, 1, '2015-04-17 00:00:00', '2015-04-17 00:00:00'),
(6, 1, 18, 1, '2015-04-17 00:00:00', '2015-04-17 00:00:00'),
(7, 1, 19, 1, '2015-04-17 00:00:00', '2015-04-17 00:00:00');
...
INSERT INTO `tb_questions` (`id`, `id_tournament`, `question`, `type_question`, `question_point`, `time_limit`, `level_question`) VALUES
(1, 1, 'Что такое SQL?', 1, 0, 0, '3'),
(2, 1, 'Найдите метод сортировки данных?', 1, 0, 0, '3'),
(3, 1, 'Какой язык программирование Python?', 1, 0, 0, '2'),
(4, 1, 'Сколько битов имеет тип boolean?', 1, 0, 0, '1'),
(5, 1, '? - выявление и устранение ошибок в программах', 2, 0, 0, '2'),
(6, 23, 'Что такое SQL?', 1, 0, 0, '3'),
(7, 1, 'Каждый юный программист может допустить синтаксическую ошибку в коде.С каждого ошибки,он учится стать лучше.', 3, 0, 0, '1');
...
`id` int(11) NOT NULL,
  ...
  `phone_number` varchar(15) COLLATE utf8_unicode_ci NOT NULL,
  `gender` varchar(1) COLLATE utf8_unicode_ci NOT NULL,
  `photo_url` varchar(200) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'person_1.png'
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(1, 'Жасдаурен', 'Дуйсебеков', '12345', '2015-03-03', 'test@com.com', '+77020322', 'M', 'image.jpg');
