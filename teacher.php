    ...
    <div class="row">
        <div class="col-2" style="position:fixed">
            <div class="list-group">
                ...
                <a role="link" href="#" name="Messages" class="list-group-item"><span class="glyphicon glyphicon-stats"></span> Рейтинг</a>
                                ...
                                <div class="panel-body">
                                    <div class="col-1">
                                        ...
                                        <div class="btn-group" role="group" aria-label="...">
                                                  <a href="question.php?id="  type="button" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-plus"></span>Preview</a>
                                                  <a href="question.php?id=" type="button" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-edit"></span>Edit</a>
                                                  <a href="question.php?id=" type="button" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash"></span>Delete</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript" src="../../project/js/student_js.js"></script>
</html>