    ...
    <div class="col-7">
        ...
        <div class="col-7">
            <div class="panel panel-default" style="width:98%">
                ...
                <div class="row">
                    <p class="col-10 answers_item" id="ANS1" name="1" onclick="clickAnswer(this)">
                        Вариант А
                    </p>
                </div>
                <div class="row">
                    <p class="col-10 col-offset-1 answers_item" name="2" id="ANS2" onclick="clickAnswer(this)">
                        Вариант Б
                    </p>
                </div>
                <div class="row">
                    <p class="col-10 answers_item" name="3" id="ANS3" onclick="clickAnswer(this)">
                        Вариант В
                    </p>
                </div>
                <div class="row">
                    <p class="col-10 col-offset-1 answers_item" name="4" id="ANS4" onclick="clickAnswer(this)">
                        Вариант Г
                    </p>
                </div>
            </div>
...
<script src="js/lightweight.js"></script>eei
<script type="text/javascript" src="js/script_js_question.js"></script>
</body>
</html>